    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficialBusinesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficialBusinesses_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Overtimes_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Undertimes_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkInfos_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "018014ab-c979-4700-8de7-51775bc72453", null, "Admin", "ADMIN" },
                    { "fdd3f907-bbfe-4785-911c-1e3daa8536dd", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficialBusinesses_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Undertimes_UserProfileId",
                table: "Undertimes",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkInfos_UserProfileId",
                table: "WorkInfos",
                column: "UserProfileId");
        }
